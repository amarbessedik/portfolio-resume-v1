  ...
  return (
    <div className={styles.home__page}>
      <div className={styles.left__side}>
        ...
        <div className={styles.profile__info}>
          ...
          <div className={styles.profile__info__name}>
            <h2>AMAR BESSEDIK, Ms.</h2>
            <h4>Specialty: Web Technologies</h4>
            <h4>Technology Stack: MERN (ReactJS favored)</h4>
          </div>
      ...
      <div className={styles.right__side}>
        <h3 style={{color: 'tomato'}}>I Build Mobile Responsive Websites</h3>
        <p>Open for Freelance work, Contract, &amp; Full-Time Opportunities</p>
      </div>
    </div>
  );
};
